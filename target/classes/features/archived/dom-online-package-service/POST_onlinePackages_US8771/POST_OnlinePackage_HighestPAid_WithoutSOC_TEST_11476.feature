...
@SP_67_US_8771_TEST_DDIBA_11476

Feature: Verify Verify DOM Content Service first selects all topics based on the given n-tuple values without SOC and filters the result based on the highest PA id
