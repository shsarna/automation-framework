...
#
# @SP_70_US_11732_TEST_12158

Feature: Verify that the online package artefacts are uploaded to artifactory when flag is set to true

  Scenario Outline: Verify that the online package artefacts are uploaded to artifactory when flag is set to true
