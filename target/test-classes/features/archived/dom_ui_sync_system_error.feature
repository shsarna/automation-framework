@SP72_US_10575_Test_12615 @exe09062021
Feature: Provide import/sync details in message pushed by XXXML Import Service

  @redeployDomUIDB
  Scenario Outline: Provide import/sync details in message pushed by XXXML Import Service (Import: success , dom content synchronization: success and dom ui synchronization :system error)
    ...
    Then the database table 'xxxml_v10_import.xxxml_import' should contain a row with values in '<test_folder>/then/import-db/xxxml_import_dom_ui_system_error.json'
