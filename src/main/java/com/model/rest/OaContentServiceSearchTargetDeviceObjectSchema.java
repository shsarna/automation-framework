...
public class OaContentServiceSearchTargetDeviceObjectSchema   {
  @JsonProperty("device")
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema device(String device) {
    this.device = device;
    return this;
  }
...
@Size(max=50)   public String getDevice() {
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema model(String model) {
    this.model = model;
    return this;
  }
...
@Size(max=50)   public String getModel() {
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema modelVariant(String modelVariant) {
...
@Size(max=50)   public String getModelVariant() {
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema deviceMarket(String deviceMarket) {
...
@Size(max=50)   public String getDeviceMarket() {
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema screenWidth(BigDecimal screenWidth) {
  ...
  **/
  ...
  public OaContentServiceSearchTargetDeviceObjectSchema screenHeight(BigDecimal screenHeight) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OaContentServiceSearchTargetDeviceObjectSchema oaContentServiceSearchTargetDeviceObjectSchema = (OaContentServiceSearchTargetDeviceObjectSchema) o;
    return Objects.equals(this.device, oaContentServiceSearchTargetDeviceObjectSchema.device) &&
        Objects.equals(this.model, oaContentServiceSearchTargetDeviceObjectSchema.model) &&
        Objects.equals(this.modelVariant, oaContentServiceSearchTargetDeviceObjectSchema.modelVariant) &&
        Objects.equals(this.deviceMarket, oaContentServiceSearchTargetDeviceObjectSchema.deviceMarket) &&
        Objects.equals(this.screenWidth, oaContentServiceSearchTargetDeviceObjectSchema.screenWidth) &&
        Objects.equals(this.screenHeight, oaContentServiceSearchTargetDeviceObjectSchema.screenHeight);
  }
  ...
  public String toString() {
    ...
    sb.append("class OaContentServiceSearchTargetDeviceObjectSchema {\n");
