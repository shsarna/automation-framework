...
public class OaContentServicePhonemeSchema   {
  ...
  public OaContentServicePhonemeSchema phonemeId(BigDecimal phonemeId) {
   ...
   * @return phonemeId
  **/
  @ApiModelProperty(required = true, value = "Internal id of the phoneme.")
  @NotNull
  ...
  public OaContentServicePhonemeSchema mainPhonemeValue(String mainPhonemeValue) {
...
@Size(max=400)   public String getMainPhonemeValue() {
  ...
  public OaContentServicePhonemeSchema altPhonemeValues(List<String> altPhonemeValues) {
    this.altPhonemeValues = altPhonemeValues;
    return this;
  }

  public OaContentServicePhonemeSchema addAltPhonemeValuesItem(String altPhonemeValuesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OaContentServicePhonemeSchema oaContentServicePhonemeSchema = (OaContentServicePhonemeSchema) o;
    return Objects.equals(this.phonemeId, oaContentServicePhonemeSchema.phonemeId) &&
        Objects.equals(this.mainPhonemeValue, oaContentServicePhonemeSchema.mainPhonemeValue) &&
        Objects.equals(this.altPhonemeValues, oaContentServicePhonemeSchema.altPhonemeValues);
  }
  ...
  public String toString() {
    ...
    sb.append("class OaContentServicePhonemeSchema {\n");
