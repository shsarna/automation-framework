...
public class OaContentServiceValidityObjectSchema2   {
  ...
  public OaContentServiceValidityObjectSchema2 validityCode(String validityCode) {
...
@Pattern(regexp="Z[A-Z]_[a-zA-Z0-9�������+-_]+") @Size(max=50)   public String getValidityCode() {
  ...
  public OaContentServiceValidityObjectSchema2 validityTypeName(String validityTypeName) {
...
@Size(max=50)   public String getValidityTypeName() {
  ...
  public boolean equals(Object o) {
    ...
    OaContentServiceValidityObjectSchema2 oaContentServiceValidityObjectSchema2 = (OaContentServiceValidityObjectSchema2) o;
    return Objects.equals(this.validityCode, oaContentServiceValidityObjectSchema2.validityCode) &&
        Objects.equals(this.validityTypeName, oaContentServiceValidityObjectSchema2.validityTypeName);
  }
  ...
  public String toString() {
    ...
    sb.append("class OaContentServiceValidityObjectSchema2 {\n");
