...
public class OaContentServiceSearchIpObjectSchema2   {
  @JsonProperty("name")
  private String name = null;

  public OaContentServiceSearchIpObjectSchema2 name(String name) {
    this.name = name;
    return this;
  }
...
@Size(max=50)   public String getName() {
  ...
  public boolean equals(Object o) {
    ...
    OaContentServiceSearchIpObjectSchema2 oaContentServiceSearchIpObjectSchema2 = (OaContentServiceSearchIpObjectSchema2) o;
    return Objects.equals(this.name, oaContentServiceSearchIpObjectSchema2.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class OaContentServiceSearchIpObjectSchema2 {\n");
