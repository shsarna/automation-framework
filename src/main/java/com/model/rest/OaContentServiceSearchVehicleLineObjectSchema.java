...
public class OaContentServiceSearchVehicleLineObjectSchema   {
  ...
  public OaContentServiceSearchVehicleLineObjectSchema vehicleLineLead(String vehicleLineLead) {
...
@Size(max=10)   public String getVehicleLineLead() {
  ...
  public OaContentServiceSearchVehicleLineObjectSchema vehicleLineVariant(String vehicleLineVariant) {
...
@Size(max=10)   public String getVehicleLineVariant() {
  ...
  public OaContentServiceSearchVehicleLineObjectSchema vehicleLineMarket(String vehicleLineMarket) {
...
@Size(max=10)   public String getVehicleLineMarket() {
  ...
  public OaContentServiceSearchVehicleLineObjectSchema businessLine(String businessLine) {
...
@Size(max=1)   public String getBusinessLine() {
  ...
  public boolean equals(Object o) {
    ...
    OaContentServiceSearchVehicleLineObjectSchema oaContentServiceSearchVehicleLineObjectSchema = (OaContentServiceSearchVehicleLineObjectSchema) o;
    return Objects.equals(this.vehicleLineLead, oaContentServiceSearchVehicleLineObjectSchema.vehicleLineLead) &&
        Objects.equals(this.vehicleLineVariant, oaContentServiceSearchVehicleLineObjectSchema.vehicleLineVariant) &&
        Objects.equals(this.vehicleLineMarket, oaContentServiceSearchVehicleLineObjectSchema.vehicleLineMarket) &&
        Objects.equals(this.businessLine, oaContentServiceSearchVehicleLineObjectSchema.businessLine);
  }
  ...
  public String toString() {
    ...
    sb.append("class OaContentServiceSearchVehicleLineObjectSchema {\n");
